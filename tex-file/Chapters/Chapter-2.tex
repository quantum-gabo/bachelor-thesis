...
Molecular dynamics (MD) is a widely used technique in condensed matter physics, for it provides a powerful framework to simulate the time evolution of many-body systems and to investigate macroscopic properties of materials, such as temperature, pressure, and energy distributions\supercite{marx2009ab, frenkel2023understanding}.



Molecular dynamics (MD) is a powerful computational technique serving to investigate many-body condensed matter systems by simulating the time evolution of its constituent particles under the influence of interatomic interactions\supercite{marx2009ab,frenkel2023understanding}. Given a set of initial conditions---positions and velocities of all atoms in the system, and the interatomic potential---MD provides a means to compute the trajectories of atoms over a time interval by solving Newton's equations of motion.
